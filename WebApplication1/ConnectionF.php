...
if (isset($_POST['submit'])) {
	...
	$password = password_hash($password,PASSWORD_DEFAULT);
     ...
     // Insert record	
	$query = "INSERT INTO `faculty` (`ID`, `User`, `Salutation`,`Name`, `DOB`, `Designation`, `Department`, `Email ID`, `Contact`, `Intercom`, `Room`, `Password`, `Security Question`, `Security Answer`,`Photo`,`Signature`) VALUES (NULL, '$user', '$sal', '$name', '$dob', '$dsgn', '$depart', '$email', '$contact', '$intercom', '$room', '$password', '$sec_ques', '$sec_ans','$pic','$sign')";
