...
<body>
 ...
 <div id="side" style="width=100%;margin-left:0%">
        <p style="background-color:green;color:white;padding:20px;margin:0px;border-radius:10px;font-size: 30px; ">Paper Selection</p>
		
	
    <div id="paper">
	<table cellpadding=30px width=100% style="text-align:center">
	
       <?php 
	   $query = "select * from faculty1 where User='$user'";
	   ...
	   if($i == 1){
	   	   ?>
		  <tr style="font-weight:bold;font-size:30px;color:green"><td>Programme</td><td>Semester</td><td>Subject</td><td>Batch</td><td>Delete Paper</td></tr> 
		   <?php
		   $i =0;
	   }
	   	   ?>
		   ...
		   <td>
			...
			<input type="hidden" id="did" name="did" value="<?php echo (isset($id))?$id:'';?>"/>
		   	<BUTTON type="submit" value="submit" style="background:gray ;width: 50%" name="del" onclick="return  confirm('Do you want to delete the paper?')"><span class="close">&times;</span></BUTTON>
		   </form>
		   </td>
		   </tr>
		   <?php
	...
	<button type="submit" value="submit" name="set" class="sbmtbtn"  style="background:green;margin-left:45%">Submit papers</button>
	</form>
