...
<body>
 ...
 <br> 
  ...
  <p align="center" style="font-size: 25px;color: #FC4031;">The fields marked with * are compulsory.</p>
<form id= 'regForm' enctype="multipart/form-data" method="post" accept-charset="utf-8"  >
  <table width='70%' cellpadding=10px style="font-size: 20px;padding:4%">
    <tr><div class="form-group">
   <td> <label class="col-sm-4 control-label">Username*</label></td>
   <td><div class="col-sm-4"><input id= "user" name="user" style="width:auto" type="text" required autocomplete="off"></div></td></div>
<div class="form-group">
   <td> <label class="col-sm-4 control-label"> Password*</label><hr style="border:none;">
		<label class="col-sm-4 control-label">Confirm Password*</label></td>
   <td><div class="col-sm-4"><input id= "pass" name="pass" type="password" style="width:auto" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required autocomplete="off"></div>
   <div class="col-sm-4"><input id="cpass" name="confirm" type="password" style="width:auto" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required autocomplete="off" onChange="checkPasswordMatch();" ></div>
</td></div></tr>
...
<tr><td></td><td></td><td></td><td><div class="registrationFormAlert" id="divCheckPasswordMatch" style="color:red;"></div></td></tr>
  ...
  <div class="form-group">
   ...
   <td><div class="col-sm-4"><input  type="date" min="1940-01-01" max="2040-12-31" name="dob" required="" autocomplete="off"></div></td></div></tr>

<tr><div class="form-group">
   <td> <label class="col-sm-4 control-label">Email Id* </label></td>
<td><div class="col-sm-4">
<input name="email" type="email" style="width:auto"  required autocomplete="off"> </div></td></div>
<div class="form-group">
   <td> <label class="col-sm-4 control-label"> Mobile No.*</label></td>
   <td> <div class="col-sm-4">
   <input name="mobile" style="width:auto" maxlength="10" type="tel" pattern="^[1-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]$"  required autocomplete="off"></div></td></div></tr>

<tr><div class="form-group">
   <td> <label class="col-sm-4 control-label">Intercom No.* </label></td>
<td><div class="col-sm-4"><input name="intercom" style="width:auto"  type="number" autocomplete="off"></div></td></div>
<div class="form-group">
   <td> <label class="col-sm-4 control-label">Room No.* </label> </td>
   <td><div class="col-sm-4"><input name="room"  style="width:auto" type="number"  required autocomplete="off"></div></td></div></tr>

<tr><div class="form-group">
   <td> <label class="col-sm-4 control-label">Upload Your Photo* </label></td>
   <td><div class="col-sm-4"><input type="file" id="pic" name="photo" style="width:auto" style="height:20px"  onChange="check(this);" required autocomplete="off">
   <p style="color: #6C8CFC;">Uploaded photo should not be greater than 100 KB</p></div></td></div>
<div class="form-group">
   <td> <label class="col-sm-4 control-label">Upload Your Signature </label></td>
   <td><div class="col-sm-4"><input type="file" id="sign" style="width:auto" name="sign" onChange="check(this);">
   <p style="color: #6C8CFC;">Uploaded photo should not be greater than 100 KB</p></div></td></div></tr>
...
<div class="form-group">
   ...
   <td><div class="col-sm-4"><input name="security_ans" type="text"  style="width:auto" required autocomplete="off"></div></td></div></tr>


</table>
<center>
<br><br>      
<button id = 'nextBtn' type="submit" name="submit" class="btn btn-success btn-md" style="width:7%">SUBMIT</button>                        <wbr>                 
