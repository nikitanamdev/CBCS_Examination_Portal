...
<body>
    ...
    <p align="center" style="color: #6C8CFC;">**Please input the details carefully and correctly**</p>
    <br />
    <br />
    <form name="myform" align="center" class="form-horizontal" role="form" id="regForm"  method="post" enctype="multipart/form-data">
        <div class="tab">
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input class="form-control" id="focusedInput" type="text" maxlength="11" minlength="11" name="enrollment_no" required autocomplete="off">
					<p style="color: #6C8CFC;">*Please enter your complete Enrollment No.</p>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    ...
                    <p style="color: #6C8CFC;">*Please enter your full name</p>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <select class="form-control" id="focusedInput" name="course_branch" required="required">
						...
						<option value="M.Plan">Master of Planning(M.Plan)</option>
                    </select>
                </div>
            </div>
           <!--  <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
					...
					<p style="color: #6C8CFC;">*Please enter in dd-mm-yyyy format</p>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input class="form-control" id="focusedInput" type="text" maxlength = "6" pattern="^[1-9][0-9][0-9][0-9][0-9][0-9]$" name="Pin_Code" autocomplete="off">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-4 control-label"> Contact Number</label>
                <div class="col-sm-4">
                    <input class="form-control" id="focusedInput" type="tel" name="contact" maxlength="10" pattern="^[1-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]$" required="required" autocomplete="off">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-4 control-label"> Alternate Contact Number</label>
                <div class="col-sm-4">
                    <input class="form-control" id="focusedInput" type="tel" name="alt_cont" maxlength="10" pattern="^[1-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]$" required="required" autocomplete="off">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-4 control-label"> Percentage In 10th</label>
                <div class="col-sm-4">
                    <input class="form-control" id="focusedInput" type="text" name="tenth" maxlength="3" required="required" autocomplete="off">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-4 control-label"> Percentage In 12th</label>
                <div class="col-sm-4">
                    <input class="form-control" id="focusedInput" type="text" name="twelvth" maxlength="3" required="required" autocomplete="off">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-4 control-label"> Passing year of 12th</label>
                <div class="col-sm-4">
                    <input class="form-control" id="focusedInput" type="text" name="passyear" maxlength="4" required="required" autocomplete="off">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    ...
                    <p align="center" style="color: #6C8CFC;">Please enter the email correctly as the Login Details will be sent on the registered email id only</p>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    ...
                    <p style="color: #6C8CFC;">*Please at least one number and one uppercase and lowercase letter, and at least 8 or more characters</p>
                </div>
            </div>
            <div class="form-group">
        ...
        <div class="tab">
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    ...
                    <p style="color: #6C8CFC;">Uploaded photo should not be greater than 100 KB</p>
                </div>
            </div>
            <div class="form-group">
